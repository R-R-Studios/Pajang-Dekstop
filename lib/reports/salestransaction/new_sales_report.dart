...
import 'package:beben_pos_desktop/reports/salestransaction/widget/pdf_transaction.dart';
import 'package:beben_pos_desktop/utils/size_config.dart';
import 'package:flutter/material.dart';
import '../bloc/report_bloc.dart';
import 'bloc/sales_report_bloc.dart';
import 'datasource/new_sales_report_data_source.dart';

class NewSalesReport extends StatefulWidget {
  const NewSalesReport({Key? key}) : super(key: key);

  @override
  _NewSalesReportState createState() => _NewSalesReportState();
}
...
class _NewSalesReportState extends State<NewSalesReport> {
  ...
  List<ReportTransaction> listTransactionForPDF = [];
  ...
  List<HeadColumnModel> _headColumnModel = [
    ...
    HeadColumnModel(key: "3", name: "Tipe", ischecked: false),
    HeadColumnModel(key: "4", name: "Payment", ischecked: false),
    HeadColumnModel(key: "5", name: "Total", ischecked: false),
    HeadColumnModel(key: "6", name: "Pembayaran", ischecked: false),
    HeadColumnModel(key: "7", name: "", ischecked: false),
  ];
  ...
  Widget transactionDataSource(context) => Container(
    ...
    child: FutureBuilder(
        future: salesReportBloc.futureGetSalesTransactionReport(
            selectedDateString, selectedToDateString),
        builder: (BuildContext ctx, AsyncSnapshot<List<ReportTransaction>> snapshot) {
