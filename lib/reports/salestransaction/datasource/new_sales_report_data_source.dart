...
class NewSalesReportDataSource extends DataTableSource {
  NewSalesReportDataSource(
      this.context,
      List<ReportTransaction> reportTransactionModels,
      this.salesReportBloc,
      this.startDate,
      this.endDate,
      this.merchantName) {
          ...
          child: ElevatedButton(
            onPressed: () {
              showDetailTransaction(
                  row.transactionCode ?? "0", row.date ?? "-");
            },
            child: Text("Detail"),
    ...
    return showDialog(
        ...
        builder: (BuildContext ctx) => Dialog(
              ...
              child: Padding(
                  ...
                  child: FutureBuilder(
                    future: salesReportBloc
                        .getDetailSalesTransactionReport(transactionCode),
                    builder: (BuildContext context,
                        AsyncSnapshot<ReportTransaction> snapshot) {
                          ...
                          children: [
                                ...
                                Row(
                                  children: [
                                    Container(
                                      ...
                                      child: ElevatedButton(
                                        onPressed: () async {
                                          await PDFDetailTransaction
                                              .generatePDFDetailTransaction(
                                                  date,
                                                  transactionCode,
                                                  temp,
                                                  merchantName);
                            ...
                            Container(
                              ...
                              child: PaginatedDataTable(
                                  rowsPerPage: temp.length > 5
                                      ? 5
                                      : temp.length > 0 && temp.length < 5
                                          ? temp.length
                                          : 0,
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Container(
                                      margin: EdgeInsets.only(left: 12),
                                      child: Text(
                                        '${Core.converNumeric(totalTransaction.toString())}',
                                        style: TextStyle(
                                            fontWeight: FontWeight.bold,
                                            fontSize: 16),
                                      )),
