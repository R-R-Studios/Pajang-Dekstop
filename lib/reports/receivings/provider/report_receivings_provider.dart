...
class ReportReceivingsProvider {
  static Future<List<ReportReceivingsModel>> searchReportReceivings(String merchantId,String productName, String startDate, String endDate) async {
    ...
    await DioService.checkConnection(isUseBearer: true, tryAgainMethod: null).then((value) async {
      ...
      var searchReport = await dio.searchReportReceivings(merchantId, productName, startDate, endDate);
      if(searchReport.meta.code! < 300){
        ResponseReportReceivingsModel response = ResponseReportReceivingsModel.fromJson(jsonDecode(jsonEncode(searchReport.data)));
